...
def init_mock(gateway):
    ...
    gateway.request_session.mount('https://smart.gardena.com/', adapter)


def init_failed_mock(gateway):
    adapter = requests_mock.Adapter()
    adapter.register_uri('POST',
                         'https://smart.gardena.com/sg-1/sessions',
                         json={},
